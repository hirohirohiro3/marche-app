...
const sections = [
  ...
  {
    title: '2. 収集する利用者情報及び収集方法',
    content: [
      '本サービスにおいて当方が収集する利用者情報は、以下のとおりです。',
      <List key="list-1" dense sx={{ pl: 2 }}>
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}>
          <ListItemText
        ...
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}>
          <ListItemText
            primary="顧客識別ID (uid):"
            secondary="利用者が本サービスを通じて注文を行った場合、注文状況を追跡・表示するために、利用者のブラウザ（LocalStorage等）に一時的な顧客識別ID (uid) を保存します。このIDは個人を直接特定するものではありませんが、利用者のデバイスに紐づく情報となります。"
          />
        </ListItem>
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}>
          <ListItemText
            primary="お問い合わせフォームを通じて提供される情報:"
            secondary="利用者が本サービス内のお問い合わせフォームを通じて連絡を行う場合、任意で提供される氏名、返信用メールアドレス、お問い合わせ内容等の情報を収集します。"
          />
        </ListItem>
      </List>
    ],
  },
  {
    ...
    content: [
      ...
      <List key="list-2" dense sx={{ pl: 2 }}>
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}><ListItemText primary="本サービスの提供、維持、改善のため（例：注文処理、注文状況の表示）" /></ListItem>
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}><ListItemText primary="本サービスの利用状況の分析のため" /></ListItem>
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}><ListItemText primary="本サービスに関するお問い合わせ等への対応のため（お問い合わせフォームからの連絡への返信を含みます）" /></ListItem>
        <ListItem sx={{ display: 'list-item', py: 0.5, listStyleType: 'disc', pl: 1 }}><ListItemText primary="本規約等に違反する行為に対する対応のため" /></ListItem>
      </List>
    ],
  },
  {
  ...
  {
    title: '6. Cookie、LocalStorage等の技術の利用',
    content: [
